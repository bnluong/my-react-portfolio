...
export const projects = [
	{
		projectTitle: "Patientor (2022)",
		projectImg: process.env.PUBLIC_URL + "/projects/patientor.png",
		projectShortDescription: "Patientor is a simple medical record storage system",
		projectDescription: [
			"Patientor is a digital medical records storage system which allows users to add, remove, and update patients' information and their medical diagnostic",
			"The project is currently in development using the MERN stack and TypeScript",
		],
		projectLinks: [],
		projectSkills: ["TypeScript", "React", "Redux", "SemanticUI", "Node", "Express", "MongoDB", "REST"],
	},
	{
		projectTitle: "React Portfolio (2021)",
	...
	{
		projectTitle: "Buy-a-Movie (2020)",
		projectImg: process.env.PUBLIC_URL + "/projects/buy_a_movie.png",
		projectShortDescription: "Buy-a-Movie is a mock e-commerce website that sells movies",
		projectDescription: [
	...
	{
		projectTitle: "Nightmare Survivor (2019)",
	...
	{
		projectTitle: "LIDAR Filters (2019)",
		projectImg: process.env.PUBLIC_URL + "/projects/lidar.png",
		projectShortDescription: "Two LIDAR filters to reduce noise in data collected by a LIDAR sensor",
		projectDescription: [
	...
	{
		projectTitle: "Simple Search Engine (2019)",
		projectImg: process.env.PUBLIC_URL + "/projects/simple_search_engine.png",
		...
		projectLinks: [],
		projectSkills: ["Python 3", "RegEX", "NLTK", "Web Scraping", "TF-IDF Indexing"],
	},
];
